...
const {
  uploadCarPicture
} = require("./controllers/carManagementController");
//authentihcation and aitherization import
const {
  authenticateToken
...
app.get('/protected', authenticateToken, (req, res) => {
  // The token has been verified and the user is authenticated
  // Continue with the processing or validation logic
...
app.post("/car-brands", addNewCarBrandValidationRules, carManagementController.addNewCarBrand);
